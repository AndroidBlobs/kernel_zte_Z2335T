...
static struct sensor_id_fs sensor_id_bin_table[] = {
	...
	{
		"ICNT86xx", {
			{0x00, "ICNT86xx_00.bin",},
			{0x01, "ICNT86xx_01.bin",},
			{0x02, "ICNT86xx_02.bin",},
			{0x10, "ICNT86xx_10.bin",},
			{0x11, "ICNT86xx_11.bin",},
			{0x12, "ICNT86xx_12.bin",},
			{0x20, "ICNT86xx_20.bin",},
			{0x21, "ICNT86xx_21.bin",},
			{0x22, "ICNT86xx_22.bin",},
			{0xff, CTS_DEFAULT_FW_NAME,},
		},
	},
	{
