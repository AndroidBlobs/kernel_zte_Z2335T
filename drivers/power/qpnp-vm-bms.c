...
extern struct qpnp_lbc_chip *the_qpnp_lbc_chip;
extern void qpnp_detect_charger_oem_type(struct qpnp_lbc_chip *chip, int battery_current);
#endif
					...
					const union power_supply_propval *val)
{
	...
	case POWER_SUPPLY_PROP_CURRENT_NOW:
		...
		#ifdef ZTE_CHARGER_TYPE_OEM
		qpnp_detect_charger_oem_type(the_qpnp_lbc_chip, chip->current_now/1000);
		#endif
		break;
	case POWER_SUPPLY_PROP_VOLTAGE_OCV:
