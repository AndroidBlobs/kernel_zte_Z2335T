...
#ifdef ZTE_BATT_SWITCH_FUNCTION
...
module_param_call(demo_charging_policy, set_store_mode, param_get_int, &demo_charging_policy, 0644);

int get_store_mode(void)
{
	pr_debug("Get_store_mode the store_mode is %d\n", demo_charging_policy);
	return demo_charging_policy;
}
#else
